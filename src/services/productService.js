...
const productService = {
    ...
    getCategories: async (params = {}) => {
        ...
        return await apiClient(`/private/categories/get-categories?${query}`);
    },
    ...
    getSubcategories: async (params = {}) => {
        const query = new URLSearchParams(params).toString();
        return await apiClient(`/private/subcategories?${query}`);
    },
    ...
    getBrands: async (params = {}) => {
        const query = new URLSearchParams(params).toString();
        return await apiClient(`/private/brands/get-brands?${query}`);
    },
    ...
    getUnits: async (params = {}) => {
        const query = new URLSearchParams(params).toString();
        return await apiClient(`/private/units/get-units?${query}`);
    },
    ...
    getTaxes: async (params = {}) => {
        const query = new URLSearchParams(params).toString();
        return await apiClient(`/private/taxes/get-taxes?${query}`);
    },
    ...
    getVariantAttributes: async (params = {}) => {
        const query = new URLSearchParams(params).toString();
        return await apiClient(`/private/variant-types/get-variant-types?${query}`);
    },
