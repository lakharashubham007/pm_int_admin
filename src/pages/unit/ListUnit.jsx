...
import { Plus, Search, Edit3, Trash2, Filter, RefreshCw, ChevronLeft, ChevronRight, ChevronDown, Ruler, ShoppingCart, UtensilsCrossed } from 'lucide-react';
...
const ListUnit = () => {
    ...
    const fetchUnits = async () => {
        setIsLoading(true);
        try {
            const data = await productService.getUnits({ masterCategory });
            if (data.success) {
                setUnits(data.units);
            } else {
