    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                masterCategory: cat.masterCategory || 'Grocery',
            ...
            <div className="category-content-pane category-form-view absolute-unified power-ui">
                ...
                <form id="edit-category-form" className="category-glass-card" onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
                        <span style={{ fontSize: '0.8rem', fontWeight: '700', color: 'hsl(var(--muted-foreground))', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.8rem' }}>
                        ...
                        <PillSlider
                            ...
                            onChange={(val) => setFormData(prev => ({ ...prev, masterCategory: val }))}
                        />
                    </div>
